...
import { TextInput, Button, Switch, PanelHeader, defaultMessages as jimuUIMessages } from 'jimu-ui'
        ...
        <div className='w-100 h-100 filter-item-panel'>
          ...
          <div className='setting-container'>
            ...
            <SettingSection title={this.i18nMessage('sqlExpr')}>
              <SettingRow label={this.i18nMessage('sqlExprDesc')} />
              <SettingRow>
              ...
              <SettingRow>
                <TextInput
                  type='textarea' style={{ height: '80px' }} className='w-100' spellCheck={false} placeholder={this.i18nMessage('setExprTips')}
